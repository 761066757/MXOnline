# Generated by Django 2.2 on 2020-04-29 14:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city_desc', models.CharField(max_length=300, verbose_name='城市描述')),
            ],
            options={
                'verbose_name': '城市信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(default='后端开发', max_length=20, verbose_name='机构类别')),
                ('type', models.CharField(choices=[('gr', '个人'), ('gx', '高校')], max_length=2, verbose_name='培训机构')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teach_Characteristic', models.CharField(default='', max_length=300, verbose_name='教学特点')),
                ('click_nums', models.IntegerField(default=0, verbose_name='点击数')),
                ('fav_nums', models.IntegerField(default=0, verbose_name='收藏人数')),
                ('age', models.IntegerField(default=0, verbose_name='学习人数')),
